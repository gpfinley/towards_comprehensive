 ...
 */
public class AcronymSvmModelTrainer implements AcronymModelTrainer {
    ...
    // logistic or svm
    private final String MODEL_TYPE = "svm";
    ...
    public AcronymSvmModelTrainer(String expansionMapFile, String uniqueIdMapFile) throws IOException {
